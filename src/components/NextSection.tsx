...
export default function NextSection() {
  ...
  return (
    <section id="feedback" className="w-full bg-white text-black min-h-screen py-8 md:py-24 px-6 md:px-12 lg:px-[120px] flex flex-col justify-center overflow-hidden">
      <motion.div 
        initial="hidden"
        whileInView="visible"
