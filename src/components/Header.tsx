  ...
  return (
    ...
    >
      <motion.nav
        ...
        className={`pointer-events-auto grid w-full max-w-6xl grid-cols-[1fr_auto] items-center gap-x-2 gap-y-1 rounded-xl border p-1.5 text-white min-[560px]:flex min-[560px]:justify-between md:px-2 ${
